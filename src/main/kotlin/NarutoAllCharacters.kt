...
val teamKakashi = listOf(naruto, sasuke, sakura)
...
val teamAsuma = listOf(shikamaru, choji, ino)
...
val teamKurenai = listOf(hinata, kiba, shino)
...
val teamGuy = listOf(rockLee, neji, tenten)
...
val teamSunagakure = listOf(gaara, kankuro, temari)
